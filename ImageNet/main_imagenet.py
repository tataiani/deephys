...
from SENN.conceptizers import image_fcc_conceptizer, image_cnn_conceptizer, input_conceptizer, image_resnet_conceptizer
...
train_classes = np.array(np.genfromtxt('/home/cs16resch11006/DATASET/AwA2/AwA2/trainclasses.txt', dtype='str'))
test_classes = np.array(np.genfromtxt('/home/cs16resch11006/DATASET/AwA2/AwA2/testclasses.txt', dtype='str'))
classes = np.array(np.genfromtxt('/home/cs16resch11006/DATASET/AwA2/AwA2/classes.txt', dtype='str'))[:,-1]
predicates = np.array(np.genfromtxt('/home/cs16resch11006/DATASET/AwA2/AwA2/predicates.txt', dtype='str'))[:,-1]
predicate_binary_mat = np.array(np.genfromtxt('/home/cs16resch11006/DATASET/AwA2/AwA2/predicate-matrix-binary.txt', dtype='int'))
predicate_continuous_mat = np.array(np.genfromtxt('/home/cs16resch11006/DATASET/AwA2/AwA2/predicate-matrix-continuous.txt', dtype='float'))
...
def load_cifar_data(valid_size=0.1, shuffle=True, resize = None, random_seed=2008, batch_size = 64,
    ...
    """
    data_path = "/home/cs16resch11006/DATASET/ImageNet/"
    traindir = os.path.join(data_path, 'train')
    # valdir = os.path.join(data_path, 'val')
    valdir = "/home/cs16resch11006/DATASET/imagenetv2-top-images-format-val"
    ...
    # Create DataLoader
    dataloader_args = dict(batch_size=batch_size, shuffle=True, num_workers=num_workers, pin_memory=True)
...
def main():
    ...
    model_path, log_path, results_path = generate_dir_names('ImageNet', args)

    train_loader, test_loader, train_tds, test_tds = load_cifar_data(
    ...
    if args.train or not args.load_model or (not os.path.isfile(os.path.join(model_path,'model_best.pth.tar'))):
        trainer.train(train_loader, test_loader, epochs = args.epochs, save_path = model_path)
    ...
    # concept_grid(model, test_loader, top_k = 30, cuda = args.cuda, save_path = results_path + '/concept_grid.pdf')
